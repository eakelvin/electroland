      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className='mb-4'>Ring Road Central, adjacent to IZWE Ghana.</p>
            <p className='mb-4'>+233 242 439 437</p>
            <p className='mb-4'>info@electrolandgh.com</p>
          </div>
          <div>
          ...
          <div>
            <h6 className="mb-4 flex justify-center font-semibold uppercase md:justify-start text-secondary-800 dark:text-secondary-200">
            ...
            <div className="mb-4 flex items-center justify-center md:justify-start relative border-b-4 border-indigo-500" data-te-input-wrapper-init>
            <input
                type="text"
